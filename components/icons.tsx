...
export const BeakerIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c.239.02.476.043.71.066A11.933 11.933 0 0 1 12 3c1.393 0 2.73.185 4.04.518C17.47 3.73 18 4.39 18 5.174v2.096c0 .62-.356 1.183-.884 1.458L15 10.5M9.75 3.104a11.933 11.933 0 0 0-2.24.518C6.53 3.73 6 4.39 6 5.174v2.096c0 .62.356 1.183.884 1.458L9 10.5m0-7.396V18.75c0 .621.504 1.125 1.125 1.125h2.25c.621 0 1.125-.504 1.125-1.125V10.5m-4.5 0h4.5" />
  </svg>
);
